...
class TestAllEvidencesMuted(unittest.TestCase):
    ...
    def test_none_element_sent(self):
        ...
        with self.assertRaisesRegexp(ValueError, expected_message):
            mASAPP_CI.all_evidences_muted(self.usr, element=input_data)
    ...
    def test_result_field_not_sent_in_element(self):
        ...
        expected_message = "[X] The mASAPP response has not the expected structure. Missing field - result"
    ...
    def test_muted_field_not_sent_in_element(self):
        ...
        self.assertFalse(mASAPP_CI.all_evidences_muted(self.usr, element=input_data))
    ...
    def test_all_muted_evidences_in_element(self):
        input_data = json.loads(open("test/data/evidence_without_muted_fields.json").read())
        self.assertTrue(mASAPP_CI.all_evidences_muted(self.usr, element=input_data))
